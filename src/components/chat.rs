        ...
        html! {
            <div class="flex w-screen">
                ...
                <div class="grow h-screen flex flex-col">
                    <div class="w-full h-14 border-b-2 bg-[#E754A6] border-gray-300 text-white"><div class="text-xl p-3">{"💬 Chat!"}</div></div>
                    <div class="w-full grow overflow-auto border-b-2 bg-[#E754A6]">
                        {
                    ...
                    <div class="w-full h-14 flex px-3 items-center bg-[#FFB6C1]">
